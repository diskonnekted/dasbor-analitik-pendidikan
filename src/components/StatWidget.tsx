...
export const StatWidget = ({
  ...
  return (
    <div
      className="bg-white border-2 border-[#141414] rounded-none shadow-hd-lg p-5 flex flex-row items-center gap-4"
    >
      <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center border-2 border-[#141414] bg-blue-100 text-[#141414] shadow-hd rounded-none">
        {icon}
      </div>
